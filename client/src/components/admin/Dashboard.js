                ...
                <div className="col-12 col-md-10">
                        ...
                        <div className="col-xl-12 col-sm-12 mb-3">
                            <div className="card text-black bg-light border border-dark o-hidden h-100">
                                <div className="card-body">
                                    <div className="text-center card-font-size">Ukupan iznos<br /> <b>$4567</b>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row pr-4">
                        ...
                        <div className="col-xl-3 col-sm-6 mb-3">
                            <div className="card text-black bg-light border border-dark o-hidden h-100">
                                <div className="card-body">
                                    <div className="text-center ml-2 card-font-size">Porudžbine<br /> <b>125</b></div>
                                </div>
                        ...
                        <div className="col-xl-3 col-sm-6 mb-3">
                            <div className="card text-black bg-light border border-dark o-hidden h-100">
                                <div className="card-body">
                                    <div className="text-center ml-2 card-font-size">Korisnici<br /> <b>45</b></div>
                                </div>
